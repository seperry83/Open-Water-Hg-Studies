...
```{r mehg total load barplots, fig.width = 8.5}
...
```{r mehg net load barplots, fig.width = 8.5}
...
```{r hg total load barplots, fig.width = 8.5}
...
```{r hg net load barplots, fig.width = 8.5}
...
```{r oc total load barplots, fig.width = 8.5}
...
```{r oc net load barplots, fig.width = 8.5}
