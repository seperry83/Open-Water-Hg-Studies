...
flow.se <- bind_rows(flow.se.in, flow.se.out) %>% 
  mutate(
    SamplingEvent = case_when(
      Date %in% c("2014-12-22", "2014-12-23") ~ "Dec 22-23",
      Date %in% c("2016-03-15", "2016-03-16") ~ "Mar 15-16",
      Date %in% c("2017-01-11", "2017-01-12") ~ "Jan 11-12",
      Date %in% c("2017-01-24", "2017-01-25") ~ "Jan 24-25",
      Date %in% c("2017-01-31", "2017-02-01") ~ "Jan 31-Feb 1",
      Date %in% c("2017-02-14", "2017-02-15") ~ "Feb 14-15",
      Date %in% c("2017-03-01", "2017-03-02") ~ "Mar 1-2",
      Date %in% c("2017-03-15", "2017-03-16") ~ "Mar 15-16",
      Date %in% c("2017-03-28", "2017-03-29") ~ "Mar 28-29",
      Date %in% c("2017-04-11", "2017-04-12") ~ "Apr 11-12",
      Date %in% c("2017-04-25", "2017-04-26") ~ "Apr 25-26"
    )
  ) %>% 
