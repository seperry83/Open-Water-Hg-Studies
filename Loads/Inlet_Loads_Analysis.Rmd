...
loads_plots_mehg %>% pull(boxplots) %>% chuck(1) %>% ggplotly()
```
...
loads_plots_hg %>% pull(boxplots) %>% chuck(1) %>% ggplotly()
```
...
loads_plots_oc %>% pull(boxplots) %>% chuck(1) %>% ggplotly()
```
...
loads_plots_ss %>% pull(boxplots) %>% chuck(1) %>% ggplotly()
```
